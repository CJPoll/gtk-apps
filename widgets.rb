...
require_relative 'lib/compositor/adapters/hyprland_events'
require_relative 'lib/compositor/adapters/gdk_monitors'
require_relative 'lib/compositor/domain/workspace'
require_relative 'lib/bar/ui/widget_timers'
...
require_relative 'lib/bar/adapters/sni_host'
require_relative 'lib/bar/adapters/sni_watcher'
require_relative 'lib/bar/ui/tray_widget'
